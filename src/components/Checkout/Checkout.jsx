...
const Checkout = () => {
  ...
  let shipping = 0;
  shipping = subTotalPrice < 100 ? subTotalPrice * 0.1 : 0;
...
const CartData = ({
  ...
  useEffect(() => {
    ...
    setAmountMAD(totalPrice * exchangeRate);
  }, []);

  return (
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      <div className="flex justify-between">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Total partiel:</h3>
        <h5 className="text-[18px] font-[600]">{subTotalPrice}$</h5>
      </div>
      <br />
      <div className="flex justify-between">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Expédition:</h3>
